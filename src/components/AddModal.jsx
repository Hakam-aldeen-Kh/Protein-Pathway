  ...
  return (
    ...
    >
      <div className="flex justify-between items-center pb-5">
        <h2 className="text-xl font-bold">Add New Reaction</h2>
      ...
      <form className="flex flex-col space-y-5 bg-white rounded-lg">
        <InputField label="Reaction ID" value="" />
        ...
        <div className="grid grid-cols-2 gap-x-5">
          ...
          />
          <InputField value="" label={""} placeholder="G443596" />
        </div>
        ...
        <InputField label="Sugar Nucleotide" value="" placeholder={"e.g. Glucose"} />
        ...
        <div className="grid grid-cols-2 gap-x-5">
          <SelectField
            ...
            options={[{ label: "GlyToucan ID", value: "GlyToucan ID" }]}
          />{" "}
          <InputField value="" label={""} placeholder={"e.g. G0468765A"} />
        </div>

        <InputField label="Cellular Localization" value="" placeholder={"Golgi"} />
