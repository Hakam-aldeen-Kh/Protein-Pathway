    ...
    <div className="flex flex-col mt-16 w-full max-md:mt-10 max-md:max-w-full">
      <div className="flex flex-col w-full max-md:max-w-full">
        ...
        <div className="flex flex-wrap gap-5 mt-2 w-full max-md:max-w-full">
          ...
          <div className="flex relative flex-1 shrink gap-5 h-full basis-0 min-w-[240px] max-md:max-w-full mt-5">
            <img
              loading="lazy"
              ...
              alt="Pathway diagram"
              className="object-contain z-0 flex-1 shrink w-full aspect-[2.87] basis-0 min-w-[240px] max-md:max-w-full relative"
            />
