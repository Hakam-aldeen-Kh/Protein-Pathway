const HeroSection = () => {
  return (
    <div className="flex overflow-hidden gap-10 justify-center items-center px-32 py-10 w-full bg-[url(/images/Hero.png)] text-white max-md:px-5 max-md:max-w-full">
