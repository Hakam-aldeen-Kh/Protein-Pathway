...
const DeleteAccountModal = ({ isOpen, closeModal, handleDelete }) => {
  return (
    ...
    >
      <h2 className="ont-bold mb-5 text-xl font-bold">Delete My Account</h2>
      <p className="text-base">
        Are you sure you want to delete your account?{" "}
      </p>
      <p className="text-[#EB5757] text-base leading-6">
        *You can still login to retrieve your account during the next 15 days,
        after that period, your account will be deleted permanently.
      </p>
