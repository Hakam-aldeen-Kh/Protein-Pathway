          ...
          <div className="flex flex-col flex-1 shrink w-full basis-0 min-w-[240px] max-md:max-w-full">
            <div className="flex flex-wrap gap-10 justify-between items-center w-full max-md:max-w-full">
              ...
              <div className="flex items-center justify-center gap-2">
                <div className="flex gap-5 items-center self-stretch my-auto text-sm font-semibold text-center g text-[#57369E]">
                  <Link
                    to="/new-pathway"
                  ...
                  >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.57 5.92969L3.5 11.9997L9.57 18.0697" className=" stroke-[#57369E]" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M20.5019 12H3.67188" className=" stroke-[#57369E]" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
